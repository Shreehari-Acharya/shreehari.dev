...
export default function ProjectCard({
  ...
  return (
    <motion.div
      className="outline outline-slate-400/35 rounded-lg mt-4 pb-3 hover:shadow-lg/25"
      whileHover={{ scale: 1.01, transition: { duration: 0.4 } }}
    >
      <div className="flex justify-between items-start border-b border-slate-400/30 px-4 py-3 mb-3.5">
        <div>
          <h2 className="text-xl text-cyan-300 hover:text-blue-400">
            {liveLink ? (
      ...
      <div className="px-3">
        ...
        <ul className="text-sm list-disc list-inside mt-2 font-light space-y-2">
        ...
        {stack && stack.length > 0 && (
          <div className="mt-4 text-sm space-x-2 text-slate-300 flex flex-wrap gap-2">
